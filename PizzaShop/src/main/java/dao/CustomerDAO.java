...
public class CustomerDAO {
    ...
    private static final String DELETE_CUSTOMER_QUERY = "DELETE FROM customers WHERE phone = ?";
    ...
    public int customerExistsByPhone(String phone) throws SQLException {
        ...
        try ( PreparedStatement stmt = conn.prepareStatement(CHECK_CUSTOMER_EXISTS)) {
    ...
    public int insertCustomer(Customer customer) throws SQLException {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(INSERT_CUSTOMER_QUERY, Statement.RETURN_GENERATED_KEYS)) {
