...
public class OrderDAO {
    ...
    public void insertOrderItems(int orderId, OrderItem[] orderItems) throws SQLException {
        ...
        try (PreparedStatement ps = conn.prepareStatement(INSERT_ORDER_ITEM_QUERY)) {
    ...
    public void updateOrderTotal(int orderId, BigDecimal total) throws SQLException {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(UPDATE_ORDER_TOTAL_QUERY)) {
    ...
    public HashMap<String, String> getOrderDetails(int orderId) throws SQLException {
        ...
        try (CallableStatement stmt = conn.prepareCall(GET_ORDER_DETAILS_PROCEDURE)) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                ...
                do {
                    ...
                    map.put("special_instructions", rs.getString("special_instructions"));
